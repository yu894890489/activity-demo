 $(function() {
	 ...
	 addfun();
	 numFormat();
	 $("#modDetp").niceScroll({styler:"fb",cursorcolor:"#e2e2e2", cursorwidth: '8', cursorborderradius: '0px', background: '#ffffff', spacebarenabled:false, cursorborder: '0',  zindex: '1000'});
 });
...
//			    				CloudUtils.setForm(data,'modDeptForm');
			         	...
			         	$("#dept_tree ").niceScroll({styler:"fb",cursorcolor:"#e2e2e2", cursorwidth: '8', cursorborderradius: '0px', background: '#ffffff', spacebarenabled:false, cursorborder: '0',  zindex: '1000'});
					}else{
...
function addfun(){
	$("#btn_add").click(function(){
		$("#orgStructurePath").val("");
	});
}

 function saveDept() {
		// formValidator();
		$('#myModal').modal({backdrop: 'static', keyboard: false});//防止点击空白/ESC 关闭
 ...
 function modDept(){
	 ...
	 var orgStructurePath = $("#orgStructurePath").val();
	 data = eval("(" + data + ")");
		var param = {
