...
public class DeptController extends BaseJsonController {
	...
	@RequestMapping(value = "/dept/tree", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean deptTree(@Valid @RequestBody DeptListReqBean reqBean,
		...
		respBean = this.deptService.getDeptTree(paramMap);

		return respBean;
	}

	@RequestMapping(value = "/dept/list", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean deptList(HttpSession httpSession,
			@RequestBody DeptListReqBean reqBean, BindingResult bindingResult) {
		BaseRespBean respBean = new BaseRespBean();
		Map<String, Object> paramMap = BeanUtil.beanToMap(reqBean);
		// 获取用户信息
	...
	@RequestMapping(value = "/dept/add", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean deptAdd(HttpSession httpSession,
			@Valid @RequestBody DeptAddReqBean reqBean,
			BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
...
//		paramMap.put("relaCorpId", corpIdSession);
	...
	@RequestMapping(value = "/dept/mod", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean deptUpdate(@Valid @RequestBody DeptUpdateReqBean reqBean,
			BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
	...
	@RequestMapping(value = "/dept/delete", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean deptDelete(@Valid @RequestBody DeptDeleteReqBean reqBean,
			BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
