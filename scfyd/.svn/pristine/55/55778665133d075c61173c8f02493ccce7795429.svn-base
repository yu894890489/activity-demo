...
import com.ut.scf.reqbean.crm.FixedExpendAddReqBean;
import com.ut.scf.reqbean.crm.FixedExpendListReqBean;
import com.ut.scf.reqbean.crm.FixedExpendUpdateReqBean;
 ...
 */
@Controller
@RequestMapping("/fixedExpend")
public class FixedExpendController extends BaseJsonController{
	@Resource IFixedExpendService fixedExpendService;
	
	private static final Logger log = LoggerFactory.getLogger(FixedExpendController.class);
	
	@RequestMapping(value = "/list", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean FixedExpendList(HttpSession httpSession,
			@RequestBody FixedExpendListReqBean reqBean) throws IOException {
...
//			}
		...
		return fixedExpendService.getFixedExpendList(paramMap, page);
		
	}
	
	@RequestMapping(value = "/add", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean FixedExpendAdd(HttpSession httpSession,
			@Valid @RequestBody FixedExpendAddReqBean reqBean,
		...
		respBean = fixedExpendService.insertFixedExpend(paramMap);
		return respBean;
		
	}
	
	@RequestMapping(value = "/delete", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean FixedExpendDelete(HttpSession httpSession,
		...
		respBean = fixedExpendService.deleteFixedExpend(recUid);
		return respBean;
		
	}
	
	@RequestMapping(value = "/mod", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean FixedExpendUpdate(HttpSession httpSession,
			@Valid @RequestBody FixedExpendUpdateReqBean reqBean,
			BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
		...
		Map<String, Object> paramMap = BeanUtil.beanToMap(reqBean);
		respBean = fixedExpendService.updateFixedExpend(paramMap);
		return respBean;
