...
public class NegativeInfo {
    ...
    public void setNonCurrentAssetsDueWithinOneYear(BigDecimal nonCurrentAssetsDueWithinOneYear) {
    ...
    public void setAvailableForSaleFinancialAssets(BigDecimal availableForSaleFinancialAssets) {
    ...
    public void setNonCurrentLiabilitiesDueWithinOneYear(BigDecimal nonCurrentLiabilitiesDueWithinOneYear) {
    ...
    public void setUnallocatedProfitSpreadsheet(BigDecimal unallocatedProfitSpreadsheet) {
    ...
    public void setBalanceOfUndistributedProfit(BigDecimal balanceOfUndistributedProfit) {
