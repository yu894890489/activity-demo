...
import com.ut.scf.reqbean.crm.FixedExpendAnalyAddReqBean;
import com.ut.scf.reqbean.crm.FixedExpendAnalyListReqBean;
import com.ut.scf.reqbean.crm.FixedExpendAnalyUpdateReqBean;
 ...
 */
@Controller
@RequestMapping("/fixedExpendAnaly")
public class FixedExpendAnalyController extends BaseJsonController{
	@Resource IFixedExpendAnalyService fixedExpendAnalyService;
	
	private static final Logger log = LoggerFactory.getLogger(FixedExpendAnalyController.class);
	
	@RequestMapping(value = "/list", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean FixedExpendAnalyList(HttpSession httpSession,
			@RequestBody FixedExpendAnalyListReqBean reqBean) throws IOException {
...
//			}
		...
		return fixedExpendAnalyService.getFixedExpendAnalyList(paramMap, page);
		
	}
	
	@RequestMapping(value = "/add", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean FixedExpendAnalyAdd(HttpSession httpSession,
			@Valid @RequestBody FixedExpendAnalyAddReqBean reqBean,
		...
		respBean = fixedExpendAnalyService.insertFixedExpendAnaly(paramMap);
		return respBean;
		
	}
	
	@RequestMapping(value = "/delete", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean FixedExpendAnalyDelete(HttpSession httpSession,
		...
		respBean = fixedExpendAnalyService.deleteFixedExpendAnaly(recUid);
		return respBean;
		
	}
	
	@RequestMapping(value = "/mod", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean FixedExpendAnalyUpdate(HttpSession httpSession,
			@Valid @RequestBody FixedExpendAnalyUpdateReqBean reqBean,
			BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
		...
		Map<String, Object> paramMap = BeanUtil.beanToMap(reqBean);
		respBean = fixedExpendAnalyService.updateFixedExpendAnaly(paramMap);
		return respBean;
