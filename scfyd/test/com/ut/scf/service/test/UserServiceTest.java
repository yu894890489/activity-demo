...
public class UserServiceTest {
	...
	@Test
	public void userChangeRoleTest() {
		log.info("userChangeRoleTest start");
		Map<String, Object> paramMap = new HashMap<>();
		paramMap.put("roleId", "ROLE000002");
		BaseRespBean respBean = userService.changeRole(paramMap);
		log.info("changeRole : " + respBean);
		Assert.assertNotNull(respBean);
		log.info("userChangeRoleTest end");
	}
	...
	public void updatePwdTest() {
		log.info("**********************************updatePwdTest start*********************************");
		UserModPwdReqBean usrModPwdBean = new UserModPwdReqBean();
		usrModPwdBean.setUserId("000000005803fc3b49040573c2a50077");
		usrModPwdBean.setNewPassword("111111");
		usrModPwdBean.setOldPassword("670b14728ad9902aecba32e22fa4f6bd");
		BaseRespBean respBean = userService.updatePwd(usrModPwdBean);
		log.info("usrModPwdBean : " + respBean);
		Assert.assertNotNull(respBean);
		log.info("**********************************updatePwdTest end*********************************");
	}
